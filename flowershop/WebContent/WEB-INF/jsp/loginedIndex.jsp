...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@3.3.7/dist/css/bootstrap.min.css" rel="stylesheet">
		 <link href="/css/txhead.css" rel="stylesheet">
        <style type="text/css">
        	.pc_imgBox{
        	display: block;
            height: 400px;
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					...
					<ul class="nav navbar-nav navbar-right">
						<li>
							 <a href="${pageContext.request.contextPath}/user/individual">个人中心</a>
						</li>
						<li>
			...
			<div class="carousel slide" id="mycarousel">
				...
				<div class="carousel-inner">
					<div class="item active">
						...
						<img alt="网上商城" src="../img/lo3.jpg" />
					    </span>
					</div>
					<div class="item">
						<span class="pc_imgBox">
						<img alt="网上商城" src="../img/lo.jpg" />
						</span>
						
					</div>
					<div class="item">
						<span class="pc_imgBox">
						<img alt="网上商城" src="../img/lo4.png" />
						</span>
		...
		<div class="col-md-12 column">
			...
			<c:forEach items="${list1}" var="l1">
				...
				<div class="col-md-3 col-sm-3">
					<div class="thumbnail">
						<img alt="300x200" src="${pageContext.request.contextPath}/logos/${l1.gpic}" />
						<div class="caption">
							<h3>
								${l1.gname}
							</h3>
							...
							<p>
								 <a class="btn btn-primary" href="${pageContext.request.contextPath}/cart/addCart/${l1.id}/1">加入购物车</a>
							</p>
						</div>
					</div>
				</div>
    ...
    <div class="row clearfix">
		<div class="col-md-12 column">
			...
			<c:forEach items="${list2}" var="l2">
				<div class="col-md-3 col-sm-3">
					<div class="thumbnail">
						<img alt="300x200" src="${pageContext.request.contextPath}/logos/${l2.gpic}" />
						<div class="caption">
							<h3>
								${l2.gname}
							</h3>
							...
							<p>
								  <a class="btn btn-primary" href="${pageContext.request.contextPath}/cart/addCart">加入购物车</a>
							</p>
						</div>
					</div>
				</div>
