...
<html>
		...
		<div class="col-sm-12 col-md-12 column">
			...
			<nav class="navbar navbar-default" role="navigation">
				<div class="navbar-header">
					 ...
					 <a class="navbar-brand" href="#"><strong>网上商城</strong>购物车</a>
				</div>
				
					<ul class="nav navbar-nav navbar-right">
						<li>
							 <a href="${pageContext.request.contextPath }/user/toIndex"></a>
						</li>
						<li>
	...
	<div class="container">
		...
		<div class="col-md-12 column">
			<div class="page-header">
				<span>全部商品<span class="badge">${goodsnum}</span></span>
			</div>
		</div>
	    </div>
	    <!--全部商品结束-->
	    		...
	    		<table class="table">
	    			...
	    			<tbody>
	    				...
	    				<tr>
	    				    ...
	    				    <td><a href="#" >-</a>&nbsp;${cartgoods.shoppingnum}&nbsp;
	    						<a href="#">+</a></td>
	    					<td>${cartgoods.smallsum}</td>
	    					<td><a href="${pageContext.request.contextPath }/cart/deleteAGoods/${cartgoods.id}">删除</a></td>
	    					</c:forEach>
	    				</tr>
	    			</tbody>
	    		</table>
	...
	<div class="well">
		...
		<div class="col-md-12 column">
			<div class="col-md-4">				
				<a href="${pageContext.request.contextPath}/cart/clearCart" class="btn btn-default">清空购物车</a>
			</div>
			<!-- 		
			<div class="col-md-4">
			...
			<div class="col-md-4 ">
				...
				<a href="${pageContext.request.contextPath}/order/orderConfirm" class="btn btn-default">结算</a>
				</div>
			</div>
		</div>
		</div>
