	...
	<div class="container">
			<div class="clearfix">
				<div class="col-md-12">
				    ...
				    <div class="main">
				    	<div>
				    		<a class="btn btn-default"  href="${pageContext.request.contextPath}/admin/toAddOrder">添加订单</a>
				    	</div>
				    	<table id="mytab" class="table table-bordered table-hover">
				    	    ...
				    	    <tr>
				    		  <td>${l.id}</td>
				    		  <td>${l.usertable_id}</td>
				    		  <td>${l.amount }</td>
				    		  <td>${l.status }</td>
				    		  <td>${l.orderdate}</td>
				    		 
				    		 <td> 
				    		    <a href="${pageContext.request.contextPath }/admin/deleteAOrder?id=${l.id}" class="btn btn-default">删除</a>
				    		    <a href="${pageContext.request.contextPath}/admin/toUpdateOrder?id=${l.id}" class="btn btn-default">修改</a>  
				    		  </td>
				    		</tr>
				            </c:forEach>
				    	    </tbody>
